...
| :--- | :--- | :--- |
| `ecg_model_simple.onnx` | **النموذج الخفيف** (Simple) | تصنيف أولي سريع لإشارات ورسوم التخطيط. |
| `ecg_model_medium.onnx` | **النموذج المتوسط** (Medium) | تحليل متوازن للموجات الكهربائية الأساسية. |
| `ecg_model_comprehensive.onnx` | **النموذج الشامل** (Comprehensive) | كشف دقيق عن الاختلالات المعقدة في ضربات القلب. |
