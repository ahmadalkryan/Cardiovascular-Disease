...
from .patient_routes import register_ai_status_route, register_patient_routes


def register_routes(app, ai_service, data_service, prediction_service, config, ecg_service):
    ...
    register_ai_status_route(app, ai_service)
