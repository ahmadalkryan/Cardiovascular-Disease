...
class Config:
    ...
    # Flask Settings
    # ================================================
    SECRET_KEY = os.environ.get('SECRET_KEY', 'heart-disease-secret-key-2024')
    ...
    MODELS_INFO = {
        'minimal': {
            ...
            'icon': '⚡', 'color': '#3498db',
            'desc': 'أسرع نموذج - يستخدم 4 ميزات فقط (Logistic Regression)',
        ...
        'top8': {
            ...
            'icon': '⭐', 'color': '#f39c12',
            'desc': 'نموذج متوازن - يستخدم 8 ميزات (Random Forest)',
        ...
        'all11': {
            ...
            'icon': '🏆', 'color': '#9b59b6',
            'desc': 'أعلى دقة - يستخدم جميع الميزات (KNN)',
    ...
    ECG_MODELS_INFO = {
        'densenet_binary': {
            ...
            'description': 'DenseNet121 - Binary Classification', 'icon': '🧠', 'color': '#3498db'
        },
        'densenet_multiclass': {
            ...
            'description': 'DenseNet121 - 3-Class Classification', 'icon': '🧬', 'color': '#9b59b6'
        },
        'onnx_original': {
            ...
            'classes_ar': ['غير طبيعي', 'احتشاء عضلة القلب', 'طبيعي', 'تاريخ مرضي'],
            'colors': ['#e74c3c', '#ff0000', '#2ecc71', '#f39c12'], 'accuracy': '94.29%',
            'description': 'ONNX Model with Median Filter', 'icon': '📊', 'color': '#e74c3c'
        }
    }
